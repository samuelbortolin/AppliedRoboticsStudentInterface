...
* @param[in]  obstacles           The obstacles.
*/
std::vector< std::vector<Point> > find_cells(std::vector< std::vector<Point> > segments, std::vector<Point> sorted_vertices, std::vector< std::vector<Point> > obstacles);
...
*/
tuple <std::vector<Point>, std::vector< std::vector<int> > create_roadmap(std::vector< std::vector<Point> > cells, std::vector<std::vector<Point>> obstacles);
