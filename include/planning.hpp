...
/*!
* Run the UCS algorithm in order to obtain all the possible paths that leads to the target. // TODO: probably we just need the first that ensures that the paths is ok for all robots
